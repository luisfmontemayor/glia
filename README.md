...
3. Install the following dependencies: `cmake`, `libuv1-dev`, `pandoc`, `libgit2-dev`, `libsecret-1-dev`, `libxml2-dev`, `libfribidi-dev`, `libharfbuzz-dev`, `libtiff-dev`, `libwebp-dev` and `libssl-dev`
